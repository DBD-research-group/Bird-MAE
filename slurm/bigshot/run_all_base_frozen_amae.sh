...
#SBATCH --job-name=bigshot_ppnet_base_frozen_amae
#SBATCH --output=/mnt/work/bird2vec/logs/bigshot/full_bigshot_ppnet_base_frozen_amae_%N_%a.log
...
CONFIG_PATH="experiment=paper/bigshot/audioMAE/frozen/${DATASETS[$DATASET_IDX]}_base_ppnet.yaml"

echo "Running experiment: ${CONFIG_PATH} with seed: ${SEED}"
DATASET_NAME=${DATASETS[$DATASET_IDX]}
scontrol update job=$SLURM_JOB_ID name="bigshot_base_frozen_ppnet_full_audioMAE_${DATASET_NAME}_seed${SEED}_${SLURM_ARRAY_TASK_ID}"
