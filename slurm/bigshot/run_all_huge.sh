...
#SBATCH --job-name=bigshot_ppnet_huge_full
#SBATCH --output=/mnt/work/bird2vec/logs/bigshot/full_bigshot_ppnet_huge_%N_%a.log
...
CONFIG_PATH="experiment=paper/bigshot/birdMAE/huge/${DATASETS[$DATASET_IDX]}_huge_ppnet.yaml"

echo "Running experiment: ${CONFIG_PATH} with seed: ${SEED}"
DATASET_NAME=${DATASETS[$DATASET_IDX]}
scontrol update job=$SLURM_JOB_ID name="bigshot_huge_ppnet_full_${DATASET_NAME}_seed${SEED}_${SLURM_ARRAY_TASK_ID}"
