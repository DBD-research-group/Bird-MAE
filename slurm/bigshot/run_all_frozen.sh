...
#SBATCH --job-name=bigshot_ppnet_large_frozen
#SBATCH --output=/mnt/work/bird2vec/logs/bigshot/frozen_bigshot_ppnet_large_%N_%a.log
...
CONFIG_PATH="experiment=paper/bigshot/birdMAE/frozenpp/${DATASETS[$DATASET_IDX]}_large_ppnet.yaml"

echo "Running experiment: ${CONFIG_PATH} with seed: ${SEED}"
DATASET_NAME=${DATASETS[$DATASET_IDX]}
scontrol update job=$SLURM_JOB_ID name="bigshot_ppnet_frozen_large_${DATASET_NAME}_seed${SEED}_${SLURM_ARRAY_TASK_ID}"
