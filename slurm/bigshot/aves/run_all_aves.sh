...
#SBATCH --job-name=bigshot_AVES_full
#SBATCH --output=/mnt/work/bird2vec/logs/bigshot/full_bigshot_aves_%N_%a.log
...
CONFIG_PATH="experiment=paper/bigshot/AVES/ft/${DATASETS[$DATASET_IDX]}_large.yaml"

echo "Running experiment: ${CONFIG_PATH} with seed: ${SEED}"
DATASET_NAME=${DATASETS[$DATASET_IDX]}
scontrol update job=$SLURM_JOB_ID name="bigshot_aves_full_${DATASET_NAME}_seed${SEED}_${SLURM_ARRAY_TASK_ID}"
